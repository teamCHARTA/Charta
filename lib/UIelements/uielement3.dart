...
class NavigationDrawer3Widget extends StatefulWidget {
  static final padding = EdgeInsets.symmetric(horizontal: 20);

  @override
  State<NavigationDrawer3Widget> createState() =>
      _NavigationDrawer3WidgetState();
}

class _NavigationDrawer3WidgetState extends State<NavigationDrawer3Widget> {
        ...
        child: Container(
          ...
          child: ListView(
            children: <Widget>[
              ...
              Container(
                padding: NavigationDrawer3Widget.padding,
                child: Column(
                  children: [
                    ...
                    buildMenuItem(
                      ...
                      onclicked: () {
                        Navigator.pushReplacementNamed(
                            context, pageRoutes.scraperorder);
                      },
                      text: 'My orders',
