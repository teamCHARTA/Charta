...
class NavigationDrawer2Widget extends StatefulWidget {
  static final padding = EdgeInsets.symmetric(horizontal: 20);

  @override
  State<NavigationDrawer2Widget> createState() =>
      _NavigationDrawer2WidgetState();
}

class _NavigationDrawer2WidgetState extends State<NavigationDrawer2Widget> {
        ...
        child: Container(
          ...
          child: ListView(
            children: <Widget>[
              ...
              Container(
                padding: NavigationDrawer2Widget.padding,
                child: Column(
                  children: [
                    ...
                    buildMenuItem(
                      ...
                      onclicked: () {
                        Navigator.pushReplacementNamed(
                            context, pageRoutes.sellerorder);
                      },
                      text: 'My orders',
